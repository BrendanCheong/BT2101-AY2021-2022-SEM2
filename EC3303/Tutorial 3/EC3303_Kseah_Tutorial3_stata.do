...
log using Tutorial3.log, replace /*creates a new log file named Tutorial3 in your working directory*/
...
log close    /*results of all your commands will be saved in the log file named Tutorial4 in your working directory*/
